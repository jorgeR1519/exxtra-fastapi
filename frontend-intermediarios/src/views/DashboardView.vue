...
<template>
  <main class="dashboard-shell">
    <section class="dashboard-card">
      <img :src="brandLogo" alt="Exxtra" class="brand-logo dashboard-logo advisor-brand-logo" />
      <span class="eyebrow">Sesion activa</span>
      <h1>Hola, {{ session?.user?.idUsuario }}</h1>
      <p>
        Esta es la base visual inicial del portal de intermediarios. Desde aqui puedes crecer hacia modulos de
        solicitudes, clientes, cartera inicial y seguimiento comercial.
      </p>

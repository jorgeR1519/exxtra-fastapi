...
<template>
  <main class="dashboard-shell">
    <section class="dashboard-card">
      ...
      <p>
        Esta es la base visual inicial del panel administrativo. Desde aqui puedes crecer hacia modulos de
        usuarios, clientes, intermediarios, solicitudes y reporteria.
      </p>
